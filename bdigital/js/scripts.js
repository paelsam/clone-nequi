...
function numericKeyboardController(a) {
    (a.setNumber = function (b) {
        a.blockKeyboard !== !0 &&
            (null === a.ngModel ? (a.ngModel += b + "") : a.ngModel.length < 4 && (a.ngModel += b + ""));
    }),
...
angular.module("App", ["restangular", "noCAPTCHA", "ui.utils.masks", "vcRecaptcha"]).run([
    "$rootScope",
    "configTemplate",
    "configProvider",
    "$location",
    ...
    function (a, b, c, d, e, f, g, h, i, j, k) {
        function l(a, b) {
            var d = c.errorData;
            return (
                "undefined" == typeof a.ResponseMessage
                    ? ((d.success = c.statusCode.fail), (d.error.errorId = ""), (d.error.errorMessage = ""))
                    : (a.ResponseMessage.ResponseHeader.Status.StatusCode === c.statusCode.statusTrue
                          ? ((d.success = c.statusCode.success), (d.data = a.ResponseMessage.ResponseBody.any[b]))
                          : (d.success = c.statusCode.fail),
        ...
        function m() {
            ...
            (a.configCountry = j[b] || j.co), (a.hideCo = "co" === b), (a.hidePa = "pa" === b);
        }
        function n() {
            m();
        }
        ...
        var o = function () {
            ...
            var b = "";
            return (a = a[0].split("/")), (b = a.length > 1 ? a[1] : c.defaultVal.url);
        };
        (a.openMenu = function () {
            ...
            (a.getClassTemplate = function () {
                var a = b.classVal[o()];
                return "undefined" == typeof a && (a = b.classVal.defaultVal), a;
            }),
            (a.getUrl = function () {
                var a = d.url().split("#");
                return (
            ...
            (a.setUrl = function (b, c) {
                d.url(b), (a.sendData = c), g.scrollTo(0, 0);
            }),
            f.setBaseUrl(c.baseService.url),
            f.setDefaultHeaders(c.baseService.header),
            f.setDefaultHttpFields({ withCredentials: !0 }),
            (a.restangularService = function (b, d, e) {
                ...
                return (
                    ...
                    d.service &&
                        d.service.version &&
                        "0.0.0" !== d.service.version &&
                        (h.RequestMessage.RequestHeader.Destination = {
                    ...
                    (g = f.all(d.url, h).withHttpConfig({ timeout: c.setting.timeout })),
            ...
            (a.jsonService = function (b, c, d) {
                var e = h.defer(),
                    f = e.promise;
                return (
                    a.restangularService(b, c, d).then(
                        function (b) {
            ...
            (a.getPSE = function () {
                if (null === window.localStorage.getItem("UrlPSE")) {
                    var b = { id: 28 };
                    a.jsonService(c.typeRequest.post, c.urlServices.parameter, b).then(
                        function (a) {
        ...
        function (a, b, c, d) {
            ...
            (f.email = ""),
                ...
                (f.saveEmail = function () {
                    var d = {};
                    /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/.test(f.email)
                        ? ((d = { recaptcha: f.captcha, email: f.email }),
    ...
    angular.module("App").controller("loginController", [
        ...
        function (a, b, c, d, e, f, g, h, i, j) {
            function k(a) {
                a.success ? (f.location.href = b.login.success) : l("response not success"), (t.isLogin = !1);
            }
            function l(a) {
                (f.location.href = b.login.fail), (t.isLogin = !1);
            }
            function m() {
                if (
                    ((t.messageError = g.getParameterByName("messageError")),
                    ...
                    var a = window.localStorage.getItem("unlockTime"),
                        b = Number(a);
                    n(b), window.localStorage.removeItem("unlockTime");
                } else if (t.changePassword) window.localStorage.setItem("changePassword", t.changePassword);
                    ...
                    var c = window.localStorage.getItem("unlockTimeIncremental"),
                        d = Number(c);
                    o(d), window.localStorage.removeItem("unlockTimeIncremental");
                }
            }
            function n(a) {
                var b = a;
                (t.modalInfo = {
                    ...
                    setTimeout(function () {
                        j.open({ modalInfo: t.modalInfo, modalAction: t.modalAction, clearModal: t.clearModal });
                    }, 1e3);
            }
            function o(a) {
                var b = a;
            ...
            function r() {
                ...
                d.addEventListener("submit", function (a) {
                    ...
                    (b.value = g.username), (e.value = g.password), (f.value = g.token), d.submit();
                });
            }
            function s(a) {
                var b = "",
            ...
            (t.isLogin = !1),
                (t.showCaptcha = !1),
                (t.auth = { username: "", password: "", token: "" }),
                            ...
                            c.encryptPassword(d.password).then(
                                function (c) {
                                    (d.password = c.password),
                                        a.jsonService(b.typeRequest.post, b.urlServices.getLogin, d).then(
                                            function (a) {
                                                k(a);
                                            },
                                            function (a) {
    ...
    angular.module("App").controller("profileResetPasswordController", [
        "$scope",
        "configProvider",
        "cypherProvider",
        "$location",
                ...
                2 !== f.length && (f = d.url().split("%23")),
                    2 === f.length
                        ? ((g = f[1].split("&")),
                          ...
                          (c.controlCode = g[0]),
                          a
                              .jsonService(b.typeRequest.post, b.urlServices.validateResetPasswordCode, c)
                              .then(function (b) {
                                  b.success ||
                                      a.setUrl("profile/error.html?region=" + a.configCountry.codigo.pais, b.error);
                              }))
                        : a.setUrl("profile/error.html?region=" + a.configCountry.codigo.pais, e.errorCatalog.r01);
            }
            var i = this;
            (i.flagPassword = !0),
                (i.password = { pwsOne: null, pwsTwo: null }),
                (i.keyOne = {}),
                (i.keyTwo = {}),
                (i.animationName = ""),
                (i.blockKeyBoard = !1),
                ...
                (i.onCancelPsw = function () {
                    (i.password.pwsOne = ""), (i.password.pwsTwo = ""), (i.flagPassword = !0);
                }),
                (i.sendNewPassword = function () {
                    f(), (i.keyOne.total = i.password.pwsOne), (i.keyTwo.total = i.password.pwsTwo);
                    var h = {},
                        j = d.url().split("#"),
                        k = "";
                    2 !== j.length && (j = d.url().split("%23")),
                        (k = j[1].split("&")),
                        c.encryptPassword(i.keyOne.total).then(
                            function (c) {
                                (h.email = k[1]),
                                    (h.controlCode = k[0]),
                                    (h.password = c.password),
                                    a.jsonService(b.typeRequest.post, b.urlServices.resetPassword, h).then(
                                        function (b) {
                                            g(),
                                                b.success
                                                    ? a.setUrl(
                                                          "profile/successresetpassword.html?region=" +
                                                              a.configCountry.codigo.pais,
                                                          b
                                                      )
                                                    : a.setUrl(
                                                          "profile/error.html?region=" + a.configCountry.codigo.pais,
                                                          b.error
                                                      );
                                        },
                                        function (b) {
    ...
    angular.module("App").directive("keyView", [
        "passwordMeterFactory",
        "$timeout",
        "messagesProvider",
        function (a, b, c) {
            return {
                ...
                link: function (d, e, f, g) {
                                ...
                                (l = d.overwrite ? !0 : !1),
                                    d.validate && l
                                        ? ((i = a.check(f)),
                                          ...
                                          k && f === d.overwrite
                                              ? (angular.element(m).removeClass("empty error").addClass("full"),
                                                b(function () {
                                                    d.success()("");
                                                }, 500))
                                              : (angular.element(m).removeClass("empty full success").addClass("error"),
                                        ...
                                        : d.validate
                                          ? ((i = a.check(f)),
                                            ...
                                            k
                                                ...
                                                : (angular
                                                      .element(m)
                                                      .removeClass("empty full success")
                                                      .addClass("error"),
                                                  (d.description = c.error.formKeyView.password[j(i.meters)])))
                                          : l
                                            ? f === d.overwrite
                                                ? (angular.element(m).removeClass("empty error").addClass("full"),
                                                  b(function () {
                    ...
                    g.$parsers.push(function (b) {
                        var c = (e.find("input"), null),
                            f = null,
                            h = "";
                        return (
                            (h = i(b)),
                            e.find("input").val(h),
                            d.validate ? ((c = a.check(h)), (f = c.isValid && 4 === h.length)) : (f = 4 === h.length),
                            k(h),
                        ...
                        (g.$render = function () {
                            ...
                            if (c)
                                d.validate
                                    ? ((f = a.check(c)), (b = f.isValid && 4 === c.length))
                                    : (b = 4 === c.length),
                                    k(c),
            ...
            return {
                ...
                link: function (c, d, e, f) {
                    ...
                    (c.toggleSelect = function () {
                        var a = d.data("state");
                        a ? (c.openClass = "") : (c.openClass = "open-select-country"), d.data("state", !a);
                    }),
                        (c.setCountry = function (d) {
                            (c.indexCountry = d),
                                ...
                                "function" == typeof c.onSelectCountry &&
                                    c.onSelectCountry({ option: c.selectedCountry });
                        }),
                        g();
                },
            };
                ...
                link: function (c, d, e) {
                    d.on("click", function (c) {
                        if (e.ga) {
                            ...
                            c.preventDefault(), a.trackEvent(e.view, d, e.ga), (location.href = e.href);
                        }
                    });
                },
            };
    ...
    angular.module("App").directive("messagePrint", [
        "messagesProvider",
        function (a) {
            return {
                scope: { htmlPrint: "=" },
                template: function (b, c) {
                    for (var d = c.messagePrint.split("."), e = a, f = 0; f < d.length; f++) e = e[d[f]];
                    return e;
                },
            };
        },
    ...
    angular.module("App").directive("popup2", [
        "$rootScope",
        "$timeout",
        "$interval",
        function (a, b, c) {
            return {
                ...
                controller: [
                    function () {
                        ...
                        function f() {}
                        function g() {
                            c.cancel(h.interval), h.closePopup();
                        }
                        var h = this;
                        (h.animationShow = ""),
                            (h.moveShow = ""),
    ...
    angular.module("App").filter("stringPhoneNumber", function () {
        return function (a, b) {
            var c,
                d = new StringMask("+00 000 000 0000"),
                e = new StringMask("000 000 0000");
            return (
                b && ((d = new StringMask(b)), (e = new StringMask(b))),
                "undefined" != typeof a && null !== a
                    ? ((a = a.replace(/-/g, "").replace(/ /g, "").replace(/\+/g, "")),
                      (c = a.length < 11 ? e.apply(a) : d.apply(a)))
                    : (c = a),
                c
            );
        };
    ...
    angular.module("App").factory("configCountryProvider", function () {
        var a = Object.freeze({
            pa: {
                codigo: { pais: "pa", tel: "+507", region: "P001" },
                imgs: {
                    logoNequi:
                        "https://uploads-ssl.webflow.com/6317a229ebf7723658463b4b/64e50b03c9fda96db04be382_logo-nequi-blanco.svg",
                    bancolombiaGroup:
                        "https://assets-global.website-files.com/63be0fb85664b94d14287a6c/640115ff970ede3928b69c21_Logo-banistmo.svg",
                    iconArrow:
                        "https://uploads-ssl.webflow.com/6317a229ebf7723658463b4b/64e573948290d271c9185df0_ic-arrow.svg",
                    logoVigilado:
                        "https://uploads-ssl.webflow.com/65ce1c19567caef6f8949f6f/65ce1f8f383741a58719b513_Vigilado%20NEQUI%20SA%20blanco.svg",
                },
                links: {
                ...
                store: {
                    ...
                    appleimg:
                        "https://uploads-ssl.webflow.com/6317a229ebf7723658463b4b/64e50ed702047ba456edd2cb_store-apple.svg",
                    android: "https://play.google.com/store/apps/details?id=pa.com.nequi.MobileApp",
                    androidimg:
                        "https://uploads-ssl.webflow.com/6317a229ebf7723658463b4b/64e50ed88b7bb33f2c2c4653_store-googleplay.svg",
                    huawei: "https://appgallery.huawei.com/app/C102297511",
                    huaweiimg:
                        "https://uploads-ssl.webflow.com/6317a229ebf7723658463b4b/64e50ed702047ba456edd25c_store-huawei.svg",
                },
                labels: [
                    {
                        id: "info-legal",
                    ...
                    },
                    {
                        ...
                        data: [{ label: "Usa el QR", link: "https://www.nequi.com.pa/usa-qr" }],
                    },
                    {
                        id: "ayuda",
                        title: "Ayuda",
                        data: [{ label: "Centro de ayuda", link: "https://ayuda.nequi.com.pa/hc/es-419" }],
                    },
                    {
                        id: "conocenos",
                        title: "Conócenos",
                        data: [{ label: "Somos Nequi", link: "https://www.nequi.com.pa/somos-nequi" }],
                    },
                ],
                socialMedia: [
                    {
                ...
                inputs: {
                    phoneNumber: { maskString: "0000 0000", regEx: "^6[\\d]{7}$+s", minlength: 8 },
                    password: { regEx: "^[0-9]*$", minlength: 4 },
                },
            },
            co: {
                codigo: { pais: "co", tel: "+57", region: "C001" },
                imgs: {
                    logoNequi:
                        "https://uploads-ssl.webflow.com/6317a229ebf7723658463b4b/64e50b03c9fda96db04be382_logo-nequi-blanco.svg",
                    bancolombiaGroup:
                        "https://uploads-ssl.webflow.com/65ce1c19567caef6f8949f6f/65ce1c19567caef6f894a575_logo-grupo-bancolombia.svg",
                    iconArrow:
                        "https://uploads-ssl.webflow.com/6317a229ebf7723658463b4b/64e573948290d271c9185df0_ic-arrow.svg",
                    logoVigilado:
                        "https://uploads-ssl.webflow.com/65ce1c19567caef6f8949f6f/65ce1f8f383741a58719b513_Vigilado%20NEQUI%20SA%20blanco.svg",
                    imgFogafin:
                        "https://uploads-ssl.webflow.com/65ce1c19567caef6f8949f6f/65df4029bf0deccb7f924447_fogafin-negro.svg",
                },
                links: {
                ...
                labels: [
                    ...
                    },
                    {
                        id: "para-negocio",
                        title: "Para tu negocio",
                        data: [{ label: "Negocios", link: "https://negocios.nequi.co/" }],
                    },
                    {
                        id: "ayuda",
                        title: "Ayuda",
                ...
                inputs: {
                    phoneNumber: { maskString: "000 000 0000", regEx: "^[0-9]*$+s", minlength: 10 },
                    password: { regEx: "^[0-9]*$", minlength: 4 },
                    token: { maskString: "000000", regEx: "^[0-9]*$+s", minlength: 6 },
                },
            },
        });
        return a;
    ...
    angular.module("App").factory("configProvider", function () {
        var a = Object.freeze({
            ...
            login: { success: "./private/", fail: "./error.jsp" },
            defaultVal: { template: "/home", views: "/home" },
            folders: { template: "views/__template", views: "views" },
            typeRequest: { get: "get", post: "post", put: "put" },
            statusCode: { transactionSuccess: "35", statusTrue: "0", success: !0, fail: !1 },
            baseService: {
            ...
            messageBody: {
                RequestMessage: {
                    RequestHeader: { Channel: "MF-001", RequestDate: "", MessageID: "1234545", ClientID: "" },
                    RequestBody: { any: {} },
                },
            },
            errorData: { error: { errorId: "", errorMessage: "" } },
            urlServices: {
                resetPassword: {
                    url: "ResetPasswordServices/getResetPassword/",
                    rs: "getResetPasswordRS",
                    rq: "getResetPasswordRQ",
                    service: { name: "ResetPasswordServices", operation: "getResetPassword", version: "1.0.0" },
                },
                ...
                getSeed: { url: "SeedService/getSeed/", rs: "getSeedServiceRS", rq: "getSeedServiceRQ" },
                saveEmail: { url: "SaveEmailServices/saveEmail/", rs: "saveEmailRS", rq: "saveEmailRQ" },
                getLogin: { url: "LoginService/getLogin/", rs: "getLoginRS", rq: "getLoginRQ" },
                parameter: { url: "ParameterService/parameter/", rs: "parameterRS", rq: "parameterRQ" },
            },
            recaptcha: { matchPage: "error.jsp" },
            cookies: { keyRecaptcha: "scn" },
        });
        return a;
    }),
    ...
    angular.module("App").factory("cookieProvider", [
        function () {
            function a(a, b, c) {
                var d = "",
                    e = new Date();
                c && (e.setTime(e.getTime() + 24 * c * 60 * 60 * 1e3), (d = "; expires=" + e.toGMTString())),
            ...
            var d = { setCookie: a, getCookie: b, eraseCookie: c };
            return d;
        },
    ]),
    angular.module("App").factory("cypherProvider", [
        "configProvider",
        "$q",
        "$rootScope",
        "messagesProvider",
        function (a, b, c, d) {
            function e() {
                var d = b.defer(),
                    e = {};
                return (
                    c.jsonService(a.typeRequest.post, a.urlServices.getSeed, {}).then(
                        function (a) {
                            (e.success = a.success), (e.data = a.data), (e.error = a.error), d.resolve(e);
                        },
                        function (a) {
                            (e.success = !1), (e.error = a), d.reject(e);
                        }
                    ),
                    d.promise
                );
                ...
                return (
                    e().then(
                        function (b) {
                            (c.success = b.success),
                                b.success
                                    ? ((c.password = f(a, b.data)), g.resolve(c))
                                    : ((c.errorMessage = d.cypher.errorGettingSeedMessage), g.reject(c));
                        },
                        function (a) {
                            (c.success = !1), g.reject(a);
                        }
                    ),
                    g.promise
                );
            ...
            var i = { encrypt: f, encryptPassword: g, encryptLogin: h, getSeed: e };
            return i;
        },
    ]),
    angular.module("App").factory("googleAnalyticsProvider", [
        "$rootScope",
        function (a) {
            function b(b, c, e, f) {
                ...
                return (
                    ...
                    d
                        ? void console.log(
                              "[Google Analytics] Tracked event. Category: " +
                                  b +
                                  ". Action: " +
                                  c +
                                  ". Label: " +
                        ...
                        : void ga("send", "event", g, c, e, f, { useBeacon: !0 })
                );
            }
            var c = { trackEvent: b },
                d = !0;
    ...
    angular.module("App").value("messagesProvider", {
        ...
        errorCatalog: {
            r01: { code: "01", errorMessage: "No puede ingresar a este sitio web" },
            r02: { code: "02", errorMessage: "No fue posible validar la información, intente mas tarde." },
        },
        unlockTime: {
            modal: {
                ...
                description:
                    "Vimos que intentaste entrar varias veces seguidas. Por seguridad, bloqueamos tu acceso a Nequi desde la web. Prueba de nuevo en unos minutos.",
            },
        },
        unlockTimeIncremental: {
            modal: {
                ...
                timerTitle: "Se desbloqueará en:",
                description:
                    "Después de varios intentos fallidos de ingreso, hemos bloqueado tu Nequi. Cambia tu clave desde tu app o espera que el bloqueo finalice para poder acceder a tu cuenta.",
            },
        },
        changePassword: {
            modal: {
        ...
        views: {
            home: {
                ...
                textThreeInfo:
                    "Claro que ya lo habías imaginado, lo que no imaginabas es que íbamos a llegar tan pronto.",
                buttonInvite: "Pedir una invitación",
                email: "Tu email",
                infoText:
                    "Autorizo a Nequi para que me envíe correos <br>electrónicos con información sobre novedades <br>y noticias del proyecto.",
                phraseOne:
                    "Haz parte de este proyecto, y podrás contarle a tus nietos como fué el día en el que todo cambió.",
            ...
            authError: { title: "Error", phraseOne: "Error de autenticación" },
            profileError: { title: "¡Error!" },
            ...
            mailsActivate: {
                ...
                titleError: "¡Ups!",
                textError:
                    "No logramos validar tu correo {0}. Recuerda que este correo dura 2 horas, si ya pasó este tiempo, debes pedir un nuevo correo.",
                back: "Volver",
            ...
            biometryActivate: {
                ...
                titleError: "¡Ups!",
                textError:
                    "Este enlace ya está muy viejo. Porfa vuelve a la App y vuelve a intentarlo para mandarte otro. ",
                back: "Volver",
        ...
        error: {
            formKeyView: {
                ...
                overwritePassword: { overwrite: "¡Ups! Las claves deben ser iguales." },
            },
        },
    }),
    angular.module("App").factory("passwordMeterFactory", [
        function () {
            function a(a) {
                var c = !1,
                    d = !1,
                    e = {},
                    f = { isValid: d, meters: e };
                return (
                    (e.repeatNumber = !1),
                    a
                        ? ((c = 0 === b(a) ? !1 : !0), (d = !c), (e.repeatNumber = c), (f.isValid = d), (f.meters = e))
                        : ((f.isValid = !1), (e.repeatNumber = !1), (f.meters = e)),
                    f
                );
            }
            function b(a) {
                for (var b = a.replace(/\s+/g, "").split(/\s*/), c = 0, d = "", e = 0; e < b.length; e++)
                    b[e].match(/[0-9]/g) && ("" !== d && parseInt(d) === parseInt(b[e]) && c++, (d = b[e]));
                return c;
            }
            var c = { check: a };
            return c;
    ...
    angular.module("App").factory("popupProvider", [
        "$rootScope",
        "configProvider",
        function (a, b) {
            function c(b) {
            ...
            var e = { open: c, close: d };
            return e;
        },
    ]),
    angular.module("App").factory("utilsProvider", [
        "configProvider",
        function (a) {
            function b(a) {
            ...
            function c(a, b) {
                return a.replace(g.formatRegex, function (a) {
                    var c,
                        d = parseInt(a.substring(1, a.length - 1));
            ...
            var g = { validateNull: b, createFormatString: c, getParameterByName: d, encodeBase64: e, decodeBase64: f };
            return (g.formatRegex = new RegExp("{-?[0-9]+}", "g")), g;
        },
    ]);
